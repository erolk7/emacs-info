...
(custom-set-variables
 ...
 '(ede-project-directories '("d:/Code/rust-learning/qif_ofx"))
 '(package-selected-packages
   '(aider aidermacs magit exec-path-from-shell toml-mode rust-playground company yasnippet flycheck lsp-ui lsp-mode rustic rust-mode)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Liberation Sans" :foundry "outline" :slant normal :weight regular :height 158 :width normal)))))
(require 'rust-mode)
...
(global-set-key (kbd "C-c C-k") 'clear-entire-buffer)
